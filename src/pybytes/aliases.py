import imp
from .common.aritmetic import sign_extend
...
def unsigned_bin(object: object = None, size: int = None) -> Binary:
    """
    Returns `Binary` object with sign_behavior set to 'unsigned'
    """
    return Binary(object, bit_lenght=size, sign_behavior='unsigned')
...
def signed_bin(object: object = None, size: int = None, raise_on_big_value=False) -> Binary:
    """
